...
{{--                    </div>--}}
                ...
                <div class="form-group">
                    <label for="exampleInputEmail">CPU</label>
                    <textarea name="pro_cpu" id="pro_cpu" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_cpu ?? old('pro_cpu') }}</textarea>
                </div>
                
                <div class="form-group">
                    <label for="exampleInputEmail">Ram</label>
                    <textarea name="pro_memory" id="pro_memory" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_memory ?? old('pro_memory') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail">Bộ nhớ</label>
                    <textarea name="pro_storage" id="pro_storage" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_storage ?? old('pro_storage') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail">Card đồ hoạ</label>
                    <textarea name="pro_graphic" id="pro_graphic" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_graphic ?? old('pro_graphic') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail">Màn Hình</label>
                    <textarea name="pro_screen" id="pro_screen" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_screen ?? old('pro_screen') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail">Kích thước</label>
                    <textarea name="pro_size" id="pro_size" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_size ?? old('pro_size') }}</textarea>
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail">Khối lượng</label>
                    <textarea name="pro_weight" id="pro_weight" class="form-control textarea" cols="5" rows="2" autocomplete="off">{{  $product->pro_weight ?? old('pro_weight') }}</textarea>
                </div>
            ...
            <div class="box-body">
                @foreach($attributes  as $key => $attribute)
                    <div class="form-group col-sm-3">
                        <h4 style="border-bottom: 1px solid #dedede;padding-bottom: 100px;">{{ $key }}</h4>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                <div class="form-group ">
                    ...
                    <textarea name="pro_content" id="pro_content" class="form-control textarea" cols="10" rows="4" >{{ $product->pro_content ?? '' }}</textarea>
